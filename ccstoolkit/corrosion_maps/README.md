...
## How to use the cli
<ins>**Pr**</ins>int the <ins>**c**</ins>orrosion <ins>**m**</ins>ap data

`python3 -m ccstoolkit.corrosion_maps.cli -cm 0.75 0.5 2e3 298.15 -pr`

Show the <ins>**pl**</ins>ot

`python3 -m ccstoolkit.corrosion_maps.cli -cm 0.75 0.5 2e3 298.15 -pl`

Save to an <ins>**o**</ins>utput to file

`python3 -m ccstoolkit.corrosion_maps.cli -cm 0.75 0.5 2e3 298.15 -o file_name`

<ins>**S**</ins>ave a pre-formated <ins>**p**</ins>lot to file

`python3 -m ccstoolkit.corrosion_maps.cli -cm 0.75 0.5 2e3 298.15 -sp file_name`

Get <ins>**h**</ins>elp

`python3 -m ccstoolkit.corrosion_maps.cli -h`
